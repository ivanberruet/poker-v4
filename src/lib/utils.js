...
export function getFinalResults(settings, game){
    ...
    const winner = settings.players.registeredPlayers.activePlayers[0]
    ...
    for(let i = 0; i < eliminatedPlayers.length; i++){
        let row = [
            ...
            timeDifference(startTime,eliminatedPlayers[i].eliminatedTime), //Tiempo de juego
